import { IImageUpload, ImageUpload } from "@/models/ImageUpload";
...
export async function DELETE(
    ...
    // Delete the document from the ImageUpload collection
    await ImageUpload.findOneAndDelete({ slug: params.slug });
